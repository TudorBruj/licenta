...
export default function RegisterForm() {
    ...
    <div className="shadow-lg p-5 rounded-lg border-t-4 border-main-color">
        ...
        <form className="flex flex-col gap-3">
            <input className="w-96 border border-gray-200 py-2 px-6" type="text" placeholder="Name" />
            ...
            <button className="bg-main-color text-bg-color font-bold cursor-pointer px-6 py-6">Register</button>

            <div className="bg-red-500 text-bg-color text-sm py-1 px-3 rounded-md mt-2">Error message</div>
            <Link className="text-sm mt-3 text-right" href={'/login'}>Already have an account?
